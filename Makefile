...
singlethread_cpu.s: singlethread_cpu.o
	objdump -dC singlethread_cpu.o > singlethread_cpu.s

singlethread_cpu.o: include/hcde.hh src/common.hh src/singlethread_cpu.cc
	g++ src/singlethread_cpu.cc -Iinclude -O3 -march=native -mtune=native -DNDEBUG=1 -c -std=c++17 -osinglethread_cpu.o -ggdb
