...
template<typename Profile>
hcde::multithread_cpu_encoder<Profile>::multithread_cpu_encoder()
    : multithread_cpu_encoder(std::thread::hardware_concurrency())
{
}


template<typename Profile>
hcde::multithread_cpu_encoder<Profile>::multithread_cpu_encoder(size_t num_threads)
    : _num_threads(num_threads) {
}


template<typename Profile>
size_t hcde::multithread_cpu_encoder<Profile>::compressed_size_bound(
...
template<typename Profile>
size_t hcde::multithread_cpu_encoder<Profile>::compress(
...
template<typename Profile>
size_t hcde::multithread_cpu_encoder<Profile>::decompress(const void *stream, size_t bytes,
